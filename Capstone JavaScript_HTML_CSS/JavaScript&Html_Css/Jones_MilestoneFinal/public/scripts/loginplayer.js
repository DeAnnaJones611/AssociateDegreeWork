                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <th>Player Email</th>
                                    <td>
                                        <input name="playeremail" id="playeremail" value={this.state.useremail} onChange={this.handleChange} />
                                    </td>
                                </tr>
                                <tr>
                                    <th>Player Password</th>
                                    <td>
                                        <input type = "password" name="playerpw" id="playerpw" value={this.state.userpw} onChange={this.handleChange} />
                                    </td>
                                </tr>
